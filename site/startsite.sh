...
export BROADLEAF_OPTS="$TOMCAT_MEMORY -Xdebug -Xrunjdwp:transport=dt_socket,address=8005,server=y,suspend=n -javaagent:target/agents/spring-instrument.jar $JREBEL_AGENT"
